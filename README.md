...
웹 기반 블록 코딩 환경과 ROS 2를 연동하여 TurtleBot3를 제어할 수 있는 교육용 플랫폼입니다. 사용자는 Scratch 방식의 블록을 드래그 앤 드롭하여 프로그램을 작성하거나, AI 자연어 입력 기능을 이용하여 원하는 동작의 블록 프로그램을 자동 생성할 수 있습니다. 생성된 블록 프로그램을 웹 브라우저를 통해 실행하면 TurtleBot3가 해당 프로그램을 실시간으로 수행합니다. 
...
AI 기반 자연어 입력 기능을 통해 사용자가 원하는 로봇 동작을 설명하면 자동으로 블록 프로그램을 생성합니다.

웹의 AI 블록 만들기 패널에서 원하는 동작을 자연어로 입력하고 AI 블록 추가 버튼을 누르면, AI가 해당 명령을 분석하여 Blockly 블록 구조를 생성합니다.

이를 통해 블록 코딩 경험이 부족한 사용자도 쉽게 로봇 프로그램을 작성할 수 있도록 지원합니다.
...
사용자는 웹 브라우저에서 Drag & Drop 방식으로 블록을 조립하여 프로그램을 작성하거나, AI 블록 만들기 패널에 자연어 프롬프트를 입력하여 프로그램을 생성할 수 있다.
