...
Ai를 활용하여 블럭 코딩을 도와줍니다. 

웹의 로봇 블럭 놀이터 Ui의 Ai 블록 만들기 파티션에 하고싶은 동작을 입력하고 Ai블록 추가 버튼을 누르면 Ai가 블록을 쌓아줍니다.

이런 프로그램을 처음 접하는 분들도 손쉽게 접근이 용이하도록 설계햐였습니다.
...
(혹은 Ai블록 만들기에 프롬프트를 입력하여 프로그램을 작성한다)
